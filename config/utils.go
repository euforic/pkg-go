...
func (c *Config) getConfigurationFiles(watchMode bool, files ...string) ([]string, map[string]time.Time) {
	...
	if !watchMode && (c.Debug || c.Verbose) {
...
func (c *Config) load(cfg interface{}, watchMode bool, files ...string) (err error, changed bool) {
	defer func() {
		if c.Debug || c.Verbose {
			if err != nil {
